...
const Navbar = () => {
  ...
  return (
    <div className="h-full flex bg-black items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      {/* LINKS */}
      <div className=" text-white hidden md:flex gap-4 w-1/3">
        {links.map((link) => (
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          <span className="text-white mr-1">VA</span>
